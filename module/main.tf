...
resource "aws_route53_record" "records" {
  ...
  name    = "${var.component_name}-dev.anushadevopsb72.online"
  type    = "A"
  ttl     = 30
    ...
    "Statement" : [
      {
        ...
        "Resource" : [
          "arn:aws:kms:us-east-1:083346358305:key/f47a8305-1229-455f-a1bd-0f925a772631",
          "arn:aws:ssm:us-east-1:083346358305:parameter/${var.env}.${var.component_name}.*"
        ]
      }
    ]
  })
